...
public class Form3Term2 extends RecyclerView.Adapter< Form3Term2.MyViewHolder>{

    private Context context;

    private  ArrayList<Form3_1> form3_1s;
    FirebaseFirestore fStore;

    public Form3Term2(Context context, ArrayList<Form3_1> form3_1s) {
        this.context = context;
        this.form3_1s = form3_1s;
        this.fStore = fStore;
    }

    @NonNull
    @Override
    public Form3Term2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form3Term2.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form3Term2.MyViewHolder holder, int position) {

        fStore = FirebaseFirestore.getInstance();

        final Form3_1 form_1_infoList = form3_1s.get(position);
        ...
        holder.mdetail7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, Form3Term2Details.class);
    ...
    public int getItemCount() {
        return form3_1s.size();
    }

    public void filterList(ArrayList<Form3_1> filteredList) {
        form3_1s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mdetail7 = itemView.findViewById(R.id.button_m_detail);
