...
public class Form3Term1 extends RecyclerView.Adapter< Form3Term1.MyViewHolder>{

    private Context context;

    private  ArrayList<Form3> form3s;
    FirebaseFirestore fStore;


    public Form3Term1(Context context, ArrayList<Form3> form3s) {
    ...
    @NonNull
    @Override
    public Form3Term1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form3Term1.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form3Term1.MyViewHolder holder, int position) {

        fStore = FirebaseFirestore.getInstance();

        final Form3 form_1_infoList = form3s.get(position);
        ...
        holder.mdetail6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, Form3Term1Details.class);
    ...
    public void filterList(ArrayList<Form3> filteredList) {
        form3s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageButton mdetail6;


        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            mdetail6 = itemView.findViewById(R.id.button_m_detail);
