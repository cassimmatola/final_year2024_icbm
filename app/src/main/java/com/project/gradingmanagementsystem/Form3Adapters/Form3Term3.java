...
public class Form3Term3  extends RecyclerView.Adapter< Form3Term3.MyViewHolder>{
    ...
    public Form3Term3(Context context, ArrayList<Form3_2> form3_2s) {
        this.context = context;
        this.form3_2s = form3_2s;
        this.fStore = fStore;
    }

    @NonNull
    @Override
    public Form3Term3.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form3Term3.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form3Term3.MyViewHolder holder, int position) {
        fStore = FirebaseFirestore.getInstance();

        final Form3_2 form_1_infoList = form3_2s.get(position);
        ...
        holder.mdetail8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, Form3Term3Details.class);
    ...
    public int getItemCount() {
        return form3_2s.size();
    }

    public void filterList(ArrayList<Form3_2> filteredList) {

        form3_2s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mdetail8= itemView.findViewById(R.id.button_m_detail);
