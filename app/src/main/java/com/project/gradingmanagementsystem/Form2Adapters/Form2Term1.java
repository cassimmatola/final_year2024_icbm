...
public class Form2Term1 extends RecyclerView.Adapter< Form2Term1.MyViewHolder>{

    private Context context;

    private  ArrayList<Form2> form2s;
    FirebaseFirestore fStore;

    public Form2Term1(Context context, ArrayList<Form2> form2s) {
    ...
    @NonNull
    @Override
    public Form2Term1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form2Term1.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form2Term1.MyViewHolder holder, int position) {
        fStore = FirebaseFirestore.getInstance();

        final Form2 form_1_infoList = form2s.get(position);
        ...
        holder.mdetail2.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void filterList(ArrayList<Form2> filteredList) {
        form2s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageButton mdetail2;

        public MyViewHolder(@NonNull View itemView) {
            super(itemView);


            mdetail2 = itemView.findViewById(R.id.button_m_detail);
