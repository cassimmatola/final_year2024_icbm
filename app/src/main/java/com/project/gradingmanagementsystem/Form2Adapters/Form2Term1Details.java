...
import com.project.gradingmanagementsystem.Form1Adapters.Form1Term3Update;
import com.project.gradingmanagementsystem.R;

public class Form2Term1Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Form2Term1Details.this, Form2Term1Update.class);
