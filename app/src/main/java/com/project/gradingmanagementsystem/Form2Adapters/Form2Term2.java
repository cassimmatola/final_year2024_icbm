...
public class Form2Term2 extends RecyclerView.Adapter< Form2Term2.MyViewHolder>{

    private Context context;

    private  ArrayList<Form2_2> form2_2s;
    FirebaseFirestore fStore;


    public Form2Term2(Context context, ArrayList<Form2_2> form2_2s) {
        this.context = context;
        this.form2_2s = form2_2s;
        this.fStore = fStore;
    }

    @NonNull
    @Override
    public Form2Term2 .MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form2Term2 .MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form2Term2 .MyViewHolder holder, int position) {
        fStore = FirebaseFirestore.getInstance();

        final Form2_2 form_1_infoList = form2_2s.get(position);
        ...
        holder.mdetail3.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public int getItemCount() {
        return form2_2s.size();
    }

    public void filterList(ArrayList<Form2_2> filteredList) {
        form2_2s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mdetail3 = itemView.findViewById(R.id.button_m_detail);
