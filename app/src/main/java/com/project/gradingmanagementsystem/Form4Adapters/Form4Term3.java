...
public class Form4Term3 extends RecyclerView.Adapter< Form4Term3.MyViewHolder>{

    private Context context;

    private ArrayList<Form4_2> form4_2s;
    FirebaseFirestore fStore;

    public Form4Term3(Context context, ArrayList<Form4_2> form4_2s) {
        this.context = context;
        this.form4_2s = form4_2s;
        this.fStore = fStore;
    }

    @NonNull
    @Override
    public Form4Term3.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form4Term3.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form4Term3.MyViewHolder holder, int position) {

        fStore = FirebaseFirestore.getInstance();

        final Form4_2 form_1_infoList = form4_2s.get(position);
        ...
        holder.mdetail11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, Form4Term3Details.class);
    ...
    public int getItemCount() {
        return form4_2s.size();
    }

    public void filterList(ArrayList<Form4_2> filteredList) {
        form4_2s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mdetail11= itemView.findViewById(R.id.button_m_detail);
