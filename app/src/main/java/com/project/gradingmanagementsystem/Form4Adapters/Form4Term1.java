...
public class Form4Term1 extends RecyclerView.Adapter< Form4Term1.MyViewHolder>{

    private Context context;

    private ArrayList<Form4> form4s;
    FirebaseFirestore fStore;


    public Form4Term1(Context context, ArrayList<Form4> form4s) {
    ...
    @NonNull
    @Override
    public Form4Term1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form4Term1.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form4Term1.MyViewHolder holder, int position) {
        fStore = FirebaseFirestore.getInstance();

        final Form4 form_1_infoList = form4s.get(position);
        ...
        holder.mdetail9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(context, Form4Term1Details.class);
    ...
    public void filterList(ArrayList<Form4> filteredList) {
        form4s= filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mdetail9= itemView.findViewById(R.id.button_m_detail);
