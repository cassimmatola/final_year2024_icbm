...
public class Form1Term2 extends RecyclerView.Adapter< Form1Term2.MyViewHolder>{


    private Context context;

    private  ArrayList<Form1_2> form1_2s;
    FirebaseFirestore fStore;

    public Form1Term2(Context context, ArrayList<Form1_2> form1_2s) {
        this.context = context;
        this.form1_2s = form1_2s;
        this.fStore = fStore;
    }
    ...
    @NonNull
    @Override
    public Form1Term2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form1Term2.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form1Term2.MyViewHolder holder, int position) {
        fStore = FirebaseFirestore.getInstance();


        final Form1_2 form_1_infoList = form1_2s.get(position);
        ...
        holder.more_marks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, Form1Term2Details.class);
    ...
    public int getItemCount() {
        return form1_2s.size();
    }

    public void filterList(ArrayList<Form1_2> filteredList) {
        form1_2s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            more_marks = itemView.findViewById(R.id.button_m_detail);
