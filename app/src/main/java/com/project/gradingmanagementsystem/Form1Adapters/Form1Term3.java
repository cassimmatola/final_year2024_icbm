...
public class Form1Term3 extends RecyclerView.Adapter< Form1Term3.MyViewHolder>{

    private Context context;
    private ArrayList<Form1_3> form1_3s;
    FirebaseFirestore fStore;

    public Form1Term3(Context context, ArrayList<Form1_3> form1_3s) {
        this.context = context;
        this.form1_3s = form1_3s;
        this.fStore = fStore;
    }

    @NonNull
    @Override
    public Form1Term3.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        int layoutResId;
        ...
        return new Form1Term3.MyViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final Form1Term3.MyViewHolder holder, int position) {
        fStore = FirebaseFirestore.getInstance();

        final Form1_3 form_1_infoList = form1_3s.get(position);
        ...
        holder.mdetail_marks1.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public int getItemCount() {
        return form1_3s.size();
    }

    public void filterList(ArrayList<Form1_3> filteredList) {
        form1_3s = filteredList;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            mdetail_marks1 = itemView.findViewById(R.id.button_m_detail);
